Public Class entCliente
    ...
    Private _ENT_HISTORICO As entHistorico
    Private _ENT_PROPAGANDA As entPropaganda
    ...
    Public Property ENT_PROPAGANDA() As entPropaganda

        Get
            Return _ENT_PROPAGANDA
        End Get

        Set(ByVal value As entPropaganda)
            _ENT_PROPAGANDA = value
        End Set

    End Property

    Public Property ENT_OBSERVACAO() As entHistorico

        Get
            Return _ENT_HISTORICO
        End Get

        Set(ByVal value As entHistorico)
            _ENT_HISTORICO = value
        End Set

    End Property


    Public Property ENT_STATUS() As entObservacao
