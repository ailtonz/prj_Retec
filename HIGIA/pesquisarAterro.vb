...
Public Class pesquisarAterro
    Private _aterro As entAterro
    Protected Rotinas As ClasseRotinasDiversas

    Const Registro As String = "Aterro"
    ...
    Private Sub LIMPAR_CAMPOS()
        ...
        Me.txtNomeFantasia.Text = String.Empty
    ...
    Private Sub txtNomeFantasia_Enter(sender As System.Object, e As System.EventArgs) Handles txtNomeFantasia.Enter
        Me.stsDescricao.Text = "NOME FANTASIA"
    End Sub

    Private Sub txtNomeFantasia_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtNomeFantasia.TextChanged
    ...
    Private Sub txtContratoValor_Enter(sender As System.Object, e As System.EventArgs) Handles txtContratoValor.Enter
