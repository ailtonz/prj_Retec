...
Public Class pesquisarCondicoes
    Private _condicao As entCondicao
    Protected Rotinas As ClasseRotinasDiversas

    Const Registro As String = "Condicao"
    ...
    Private Sub form_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Me.Text = UCase(Me.Text & " - " & "CONDIÇÕES DE PAGAMENTO")
    ...
    Private Sub REGISTRO_SELECIONAR(ByVal idRegistro As String)
        ...
        While rdrRegistro.Read
            ...
            Me.txtStatus.Text = rdrRegistro("DIAS").ToString
    ...
    Private Sub REGISTRO_SALVAR()
        ...
        Dim oNeCondicao As New negCondicao
        Dim oEtCondicao As New entCondicao
        Dim oEtUsuario As New entUsuario

        Try

            With oEtCondicao
                .IdCondicao = txtID.Text
                .CondicaoPagamento = txtDescricao.Text
                .Condicao = txtStatus.Text
            ...
            If txtID.Text = 0 And txtDescricao.Text <> "" Then
                If oNeCondicao.Incluir(oEtCondicao, myConnection, myProcedure) Then
            ...
            ElseIf txtID.Text <> 0 And txtDescricao.Text <> "" Then
                If oNeCondicao.Alterar(oEtCondicao, myConnection, myProcedure) Then
            ...
            ElseIf txtID.Text <> 0 And txtDescricao.Text = "" Then
                ...
                If MsgBox("Confirma exclusão do registro?", MsgBoxStyle.Question + vbYesNo, "Exclusão de registro.") = MsgBoxResult.Yes Then
                    If oNeCondicao.Excluir(oEtCondicao, myConnection, myProcedure) Then
    ...
    Private Sub txtStatus_Enter(sender As System.Object, e As System.EventArgs) Handles txtStatus.Enter
        Me.stsDescricao.Text = "DIA(S)"
    End Sub

    Private Sub txtStatus_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtStatus.TextChanged
        Dim contas As Integer = Me.txtStatus.MaxLength

        If contas <> 0 Then
            contas = contas - Len(txtStatus.Text)
        End If

        Me.stsDescricao.Text = "DIA(S)" & " [" & contas & "/" & Me.txtStatus.MaxLength & "]"
    End Sub
End Class