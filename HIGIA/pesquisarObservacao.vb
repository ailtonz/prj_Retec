...
Public Class pesquisarObservacao
    Private _Status As entObservacao
    Protected Rotinas As ClasseRotinasDiversas

    Const Registro As String = "ObservacaoCliente"
    ...
    Private Sub form_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Me.Text = UCase(Me.Text & " - " & "OBSERVAÇÕES")
    ...
    Private Sub REGISTRO_SELECIONAR(ByVal idRegistro As String)
        ...
        While rdrRegistro.Read
            ...
            Me.txtDescricao.Text = rdrRegistro("OBSERVACAO").ToString
            Me.txtStatus.Text = rdrRegistro("SERVICO").ToString
    ...
    Private Sub REGISTRO_SALVAR()
        ...
        Dim oNeObs As New negObservacao
        Dim oEtObs As New entObservacao
        Dim oEtStatus As New entStatusServicos
        ...
        Try
            ...
            With oEtObs
                .Id = txtID.Text
                .Observacao = txtDescricao.Text

                With oEtStatus
                    .Status = Me.txtStatus.Text
                End With
                .ENT_SERVICO = oEtStatus
            ...
            If txtID.Text = 0 And txtDescricao.Text <> "" Then
                If oNeObs.Incluir(oEtObs, myConnection, myProcedure) Then
            ...
            ElseIf txtID.Text <> 0 And txtDescricao.Text <> "" Then
                If oNeObs.Alterar(oEtObs, myConnection, myProcedure) Then
            ...
            ElseIf txtID.Text <> 0 And txtDescricao.Text = "" Then
                ...
                If MsgBox("Confirma exclusão do registro?", MsgBoxStyle.Question + vbYesNo, "Exclusão de registro.") = MsgBoxResult.Yes Then
                    If oNeObs.Excluir(oEtObs, myConnection, myProcedure) Then
    ...
    Private Sub txtDescricao_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtDescricao.TextChanged
        ...
        Me.stsDescricao.Text = "OBSERVAÇÃO" & " [" & contas & "/" & Me.txtDescricao.MaxLength & "]"
    End Sub
