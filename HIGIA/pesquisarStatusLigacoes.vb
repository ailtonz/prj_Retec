...
Public Class pesquisarStatusLigacoes
    Private _status As entStatusLigacoes
    Protected Rotinas As ClasseRotinasDiversas

    Const Registro As String = "StatusLigacoes"
    ...
    Private Sub form_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Me.Text = UCase(Me.Text & " - " & "STATUS DE LIGAÇÕES")
    ...
    Private Sub REGISTRO_SELECIONAR(ByVal idRegistro As String)
        ...
        While rdrRegistro.Read
            ...
            Me.txtDescricao.Text = rdrRegistro("STATUS").ToString
    ...
    Private Sub REGISTRO_SALVAR()
        ...
        Dim oNeStatus As New negStatusLigacoes
        Dim oEtStatus As New entStatusLigacoes
        ...
        Try
            ...
            If txtID.Text = 0 And txtDescricao.Text <> "" Then
                If oNeStatus.Incluir(oEtStatus, myConnection, myProcedure) Then
            ...
            ElseIf txtID.Text <> 0 And txtDescricao.Text <> "" Then
                If oNeStatus.Alterar(oEtStatus, myConnection, myProcedure) Then
            ...
            ElseIf txtID.Text <> 0 And txtDescricao.Text = "" Then
                ...
                If MsgBox("Confirma exclusão do registro?", MsgBoxStyle.Question + vbYesNo, "Exclusão de registro.") = MsgBoxResult.Yes Then
                    If oNeStatus.Excluir(oEtStatus, myConnection, myProcedure) Then
    ...
    Private Sub txtDescricao_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtDescricao.TextChanged
        ...
        Me.stsDescricao.Text = "STATUS DA LIGAÇÃO" & " [" & contas & "/" & Me.txtDescricao.MaxLength & "]"
    End Sub

    Private Sub txtDescricao_Enter(sender As System.Object, e As System.EventArgs) Handles txtDescricao.Enter
        Me.stsDescricao.Text = "STATUS DA LIGAÇÃO"
    End Sub
