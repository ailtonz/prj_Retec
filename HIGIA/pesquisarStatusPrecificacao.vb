...
Public Class pesquisarStatusPrecificacao
    Private _Status As entStatusPrecificacao
    Protected Rotinas As ClasseRotinasDiversas

    Const Registro As String = "StatusPrecificacao"
    ...
    Private Sub form_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Me.Text = UCase(Me.Text & " - " & "ACORDOS DE PRECIFICAÇÕES")
    ...
    Private Sub REGISTRO_SALVAR()
        ...
        Dim oNeStatus As New negStatusPrecificacao
        Dim oEtStatus As New entStatusPrecificacao
