...
Public Class pesquisarTipoCadastros
    Private _tipo As entTipoCadastros
    Protected Rotinas As ClasseRotinasDiversas

    Const Registro As String = "TipoCadastros"
    ...
    Private Sub form_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Me.Text = UCase(Me.Text & " - " & "TIPOS DE CADASTROS")
    ...
    Private Sub REGISTRO_SELECIONAR(ByVal idRegistro As String)
        ...
        While rdrRegistro.Read
            ...
            Me.txtDescricao.Text = rdrRegistro("TIPO").ToString
    ...
    Private Sub REGISTRO_SALVAR()
        ...
        Dim oNeTipo As New negTipoCadastros
        Dim oEtTipo As New entTipoCadastros
        ...
        Try
            ...
            If txtID.Text = 0 And txtDescricao.Text <> "" Then
                If oNeTipo.Incluir(oEtTipo, myConnection, myProcedure) Then
            ...
            ElseIf txtID.Text <> 0 And txtDescricao.Text <> "" Then
                If oNeTipo.Alterar(oEtTipo, myConnection, myProcedure) Then
            ...
            ElseIf txtID.Text <> 0 And txtDescricao.Text = "" Then
                ...
                If MsgBox("Confirma exclusão do registro?", MsgBoxStyle.Question + vbYesNo, "Exclusão de registro.") = MsgBoxResult.Yes Then
                    If oNeTipo.Excluir(oEtTipo, myConnection, myProcedure) Then
