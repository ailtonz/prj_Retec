...
Public Class cadastroCliente
    ...
    Private Sub F_CAD_CLIENTE_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        '' TIPO DE CADASTRO
        CARREGAR_COMBO("Select * from vw_dgv_status_tipo ORDER BY cadastro_tipo", "vw_dgv_status_tipo", Rotinas.GetConnectionStringByName("servidor"), cboCADASTRO_TIPO, "cadastro_tipo", "cadastro_tipo")

        '' PROPAGANDA
        CARREGAR_COMBO("Select * from vw_dgv_status_propagandas", "vw_dgv_status_propagandas", Rotinas.GetConnectionStringByName("servidor"), cboCADASTRO_PROPAGANDA, "PROPAGANDA", "ID")

        '' STATUS
        CARREGAR_COMBO("Select distinct CADASTRO_STATUS from vw_dgv_status_clientes order by vw_dgv_status_clientes.CADASTRO_STATUS", "vw_dgv_status_clientes", Rotinas.GetConnectionStringByName("servidor"), cboSTATUS, "CADASTRO_STATUS", "CADASTRO_STATUS")

        '' STATUS_OBSERVACAO
        CARREGAR_COMBO("Select distinct CADASTRO_STATUS_OBSERVACAO from vw_dgv_status_clientes order by vw_dgv_status_clientes.CADASTRO_STATUS_OBSERVACAO", "vw_dgv_status_clientes", Rotinas.GetConnectionStringByName("servidor"), cboSTATUS_OBSERVACAO, "CADASTRO_STATUS_OBSERVACAO", "CADASTRO_STATUS_OBSERVACAO")
    ...
    Private Sub SALVAR_CLIENTE()
        ...
        'Dim oEtStatus As New entStatusCliente
        ...
        '        If Me.cboCADASTRO_TIPO.Text = "PF" Then
        ...
        '        ElseIf Me.cboCADASTRO_TIPO.Text = "PJ" Then
    ...
    Private Sub getID_Cliente(ByVal CNPJ_CPF As String)
        ...
        Dim cmdSQL As New MySqlCommand("SELECT id_cliente,cad_usuario,cad_emissao,alt_usuario,alt_emissao FROM vw_dgv_clientes WHERE cnpj_cpf = '" + CNPJ_CPF + "' LIMIT 1", myConnection)
        ...
        With Me
            ...
            While rdrRegistro.Read
                ...
                If rdrRegistro("CADASTRO_TIPO").ToString = "PF" Then
                    ...
                    Me.cboCADASTRO_TIPO.SelectedIndex = CInt(.cboCADASTRO_TIPO.FindString(rdrRegistro("CADASTRO_TIPO").ToString))
                ...
                .txtID_CLIENTE.Text = rdrRegistro("ID").ToString
                ...
                .txtPRINCIPAL_NOME.Text = rdrRegistro("CLIENTE").ToString
                ...
                '.txtCAD_EMISSAO.Text = rdrRegistro("REGISTRO_INSERT_EMISSAO").ToString
                '.txtCAD_USUARIO.Text = rdrRegistro("REGISTRO_INSERT_USUARIO").ToString
                '.txtALT_EMISSAO.Text = rdrRegistro("REGISTRO_UPDATE_EMISSAO").ToString
                '.txtALT_USUARIO.Text = rdrRegistro("REGISTRO_UPDATE_USUARIO").ToString
    ...
    Private Sub CARREGAR_CADASTRO_CONTATO(ByVal idContatoCliente As String)
        ...
        Dim cmdSQL As New MySqlCommand("Select * from vw_dgv_clientes_contatos where ID = '" + idContatoCliente + "' ", myConnection)
        Dim rdrRegistro As MySqlDataReader
        ...
        With Me
            ...
            While rdrRegistro.Read
                ...
                '.txtCONTATO_CLIENTE_CAD_USUARIO.Text = rdrRegistro("REGISTRO_INSERT_USUARIO").ToString
                '.txtCONTATO_CLIENTE_CAD_EMISSAO.Text = rdrRegistro("REGISTRO_INSERT_EMISSAO").ToString
                '.txtCONTATO_CLIENTE_ALT_USUARIO.Text = rdrRegistro("REGISTRO_UPDATE_USUARIO").ToString
                '.txtCONTATO_CLIENTE_ALT_EMISSAO.Text = rdrRegistro("REGISTRO_UPDATE_EMISSAO").ToString
    ...
    Private Sub CARREGAR_CADASTRO_HISTORICO(ByVal idHistorico As String)
        ...
        Dim cmdSQL As New MySqlCommand("Select * from vw_dgv_clientes_historicos where ID = '" + idHistorico + "' ", myConnection)
        Dim rdrRegistro As MySqlDataReader
        ...
        With Me
            ...
            While rdrRegistro.Read
                ...
                '.txtHISTORICO_CAD_USUARIO.Text = rdrRegistro("REGISTRO_INSERT_USUARIO").ToString
                '.txtHISTORICO_CAD_EMISSAO.Text = rdrRegistro("REGISTRO_INSERT_EMISSAO").ToString
                '.txtHISTORICO_ALT_USUARIO.Text = rdrRegistro("REGISTRO_UPDATE_USUARIO").ToString
                '.txtHISTORICO_ALT_EMISSAO.Text = rdrRegistro("REGISTRO_UPDATE_EMISSAO").ToString
    ...
    Private Sub CARREGAR_GRIDE_OBRAS(ByVal idCliente As String, ByVal strProcurar As String)
        ...
        If strProcurar = "" Then
            strSQL = "SELECT * from vw_dgv_clientes_obras where (ID_CLIENTE = '" & idCliente & "')"
        Else
            strSQL = "SELECT * from vw_dgv_clientes_obras where (ENDERECO LIKE '%" & Trim(strProcurar) & "%' AND ID_CLIENTE = '" & idCliente & "')"
        End If

        Dim da As New MySqlDataAdapter(New MySqlCommand(strSQL, myConnection))

        ds.Clear()
        da.Fill(ds, "vw_dgv_clientes_obras")

        'If dgvOBRAS.RowCount > 0 Then

        With dgvOBRAS
            .DataSource = ds.Tables("vw_dgv_clientes_obras")
 ...
 "^([a-zA-Z0-9_\-\.]+)@((\[[0-9]{1,3}" + "\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([a-zA-Z0-9\-]+\" + ".)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$"
    ...
    Private Sub SALVAR_HISTORICO()
        'Dim myConnection As String = Rotinas.GetConnectionStringByName("servidor")
        'Dim oNeObservacao As New negHistorico
        'Dim oEtObservacao As New entObservacao
        'Dim oEtUsuario As New entUsuario
    ...
    Private Sub LIMPAR_CONTATO()
        ...
        With Me
            ...
            .stsREGISTRO_INSERT_EMISSAO.Text = "00/00/0000"
            .stsREGISTRO_INSERT_USUARIO.Text = .txtUser.Text
            .stsREGISTRO_UPDATE_EMISSAO.Text = "00/00/0000"
            .stsREGISTRO_UPDATE_USUARIO.Text = .txtUser.Text
    ...
    Private Sub SALVAR_CONTATO()
        ...
        Try
            ...
            '' OPERAÇÃO
            If oEtContato.Id.ToString = 0 Then
    ...
    Private Sub getID_Contato(ByVal idCliente As String)
        ...
        Dim cmdSQL As New MySqlCommand("SELECT * FROM vw_dgv_clientes_contatos WHERE id_cliente = '" + idCliente + "' LIMIT 1", myConnection)
        Dim rdrRegistro As MySqlDataReader
    ...
    Private Sub getID_Historico(ByVal idCliente As String)
        ...
        Dim cmdSQL As New MySqlCommand("SELECT * FROM vw_dgv_clientes_historicos WHERE id_cliente = '" + idCliente + "' LIMIT 1", myConnection)
        Dim rdrRegistro As MySqlDataReader
    ...
    Private Sub CARREGAR_GRIDE_CONTATOS(ByVal idCliente As String, ByVal strProcurar As String)
        ...
        If strProcurar = "" Then
            strSQL = "Select * from vw_dgv_clientes_contatos where ID_RELACAO ='" + idCliente + "'"
        Else
            strSQL = "Select * from vw_dgv_clientes_contatos where ID_RELACAO ='" + idCliente + "' AND CONTATO LIKE '%" & Trim(strProcurar) & "%'"
        End If
        ...
        'If dgvCONTATOS.RowCount > 0 Then
    ...
    Private Sub dgvOBRAS_Enter(sender As System.Object, e As System.EventArgs) Handles dgvOBRAS.Enter
        If Me.txtID_CLIENTE.Text <> 0 Then
            CARREGAR_GRIDE_OBRAS(Me.txtID_CLIENTE.Text, "")
        End If
    End Sub
    ...
    Private Function txtCONTATO_CLIENTE_CAD_USUARIO() As Object
