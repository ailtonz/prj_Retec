...
Public Class pesquisarLinks
    Private _link As entLink
    Protected Rotinas As ClasseRotinasDiversas

    Const Registro As String = "Links"
    ...
    Private Sub REGISTRO_SELECIONAR(ByVal idRegistro As String)
        ...
        While rdrRegistro.Read
            ...
            Me.txtLink.Text = rdrRegistro("LINK").ToString
    ...
    Private Sub REGISTRO_SALVAR()
        ...
        Dim oNeLink As New negLink
        Dim oEtLink As New entLink
        ...
        Try
            ...
            If txtID.Text = 0 And txtDescricao.Text <> "" Then
                If oNeLink.Incluir(oEtLink, myConnection, myProcedure) Then
            ...
            ElseIf txtID.Text <> 0 And txtDescricao.Text <> "" Then
                If oNeLink.Alterar(oEtLink, myConnection, myProcedure) Then
            ...
            ElseIf txtID.Text <> 0 And txtDescricao.Text = "" Then
                ...
                If MsgBox("Confirma exclusão do registro?", MsgBoxStyle.Question + vbYesNo, "Exclusão de registro.") = MsgBoxResult.Yes Then
                    If oNeLink.Excluir(oEtLink, myConnection, myProcedure) Then
    ...
    Private Sub txtLink_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtLink.TextChanged
        Dim contas As Integer = Me.txtLink.MaxLength

        If contas <> 0 Then
            contas = contas - Len(txtLink.Text)
        End If

        Me.stsDescricao.Text = "DESCRIÇÃO" & " [" & contas & "/" & Me.txtLink.MaxLength & "]"
    End Sub
End Class