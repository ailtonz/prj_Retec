...
Public Class pesquisarVeiculos
    Private _veiculo As entVeiculo
    Protected Rotinas As ClasseRotinasDiversas

    Const Registro As String = "Veiculo"
    ...
    Private Sub REGISTRO_SELECIONAR(ByVal idRegistro As String)
        ...
        While rdrRegistro.Read
            ...
            Me.txtDescricao.Text = rdrRegistro("PLACA").ToString
            Me.txtModelo.Text = rdrRegistro("MODELO").ToString
    ...
    Private Sub REGISTRO_SALVAR()
        ...
        Dim oNeVeiculo As New negVeiculo
        Dim oEtVeiculo As New entVeiculo
        ...
        Try
            ...
            If txtID.Text = 0 And txtDescricao.Text <> "" Then
                If oNeVeiculo.Incluir(oEtVeiculo, myConnection, myProcedure) Then
            ...
            ElseIf txtID.Text <> 0 And txtDescricao.Text <> "" Then
                If oNeVeiculo.Alterar(oEtVeiculo, myConnection, myProcedure) Then
            ...
            ElseIf txtID.Text <> 0 And txtDescricao.Text = "" Then
                ...
                If MsgBox("Confirma exclusão do registro?", MsgBoxStyle.Question + vbYesNo, "Exclusão de registro.") = MsgBoxResult.Yes Then
                    If oNeVeiculo.Excluir(oEtVeiculo, myConnection, myProcedure) Then
    ...
    Private Sub txtModelo_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtModelo.TextChanged
        Dim contas As Integer = Me.txtModelo.MaxLength

        If contas <> 0 Then
            contas = contas - Len(txtModelo.Text)
        End If

        Me.stsDescricao.Text = "MODELO" & " [" & contas & "/" & Me.txtModelo.MaxLength & "]"
    End Sub

    Private Sub txtModelo_Enter(sender As System.Object, e As System.EventArgs) Handles txtModelo.Enter
        Me.stsDescricao.Text = "MODELO"
    End Sub
