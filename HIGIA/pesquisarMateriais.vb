...
Public Class pesquisarMateriais
    Private _material As entMaterial
    Protected Rotinas As ClasseRotinasDiversas

    Const Registro As String = "Material"
    ...
    Private Sub form_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Me.Text = UCase(Me.Text & " - " & "MATERIAIS")
    ...
    Private Sub REGISTRO_SELECIONAR(ByVal idRegistro As String)
        ...
        While rdrRegistro.Read
            ...
            Me.txtDescricao.Text = rdrRegistro("MATERIAL").ToString
    ...
    Private Sub REGISTRO_SALVAR()
        ...
        Dim oNeMaterial As New negMaterial
        Dim oEtMaterial As New entMaterial
        ...
        Try
            ...
            If txtID.Text = 0 And txtDescricao.Text <> "" Then
                If oNeMaterial.Incluir(oEtMaterial, myConnection, myProcedure) Then
            ...
            ElseIf txtID.Text <> 0 And txtDescricao.Text <> "" Then
                If oNeMaterial.Alterar(oEtMaterial, myConnection, myProcedure) Then
            ...
            ElseIf txtID.Text <> 0 And txtDescricao.Text = "" Then
                ...
                If MsgBox("Confirma exclusão do registro?", MsgBoxStyle.Question + vbYesNo, "Exclusão de registro.") = MsgBoxResult.Yes Then
                    If oNeMaterial.Excluir(oEtMaterial, myConnection, myProcedure) Then
