...
Public Class bcoHistorico
    Protected BancoDados As AcessoDados

    Public Function Incluir(ByVal _Observacao As entHistorico, ByVal myConnection As String) As Boolean
    ...
    Public Function Alterar(ByVal _Observacao As entHistorico, ByVal myConnection As String) As Boolean
        Dim oBanco As New AcessoDados(myConnection)
    ...
    Public Function Excluir(ByVal _Observacao As entHistorico, ByVal myConnection As String) As Boolean
        Dim oBanco As New AcessoDados(myConnection)
