...
Public Class bcoFuncionario
    ...
    Public Function Incluir(ByVal _funcionario As entFuncionario, ByVal myConnection As String, ByVal myProcedure As String) As Boolean
        ...
        With oBanco
            ...
            .AdicionaParametro("p_ID", _funcionario.Id.ToString)
            ...
            .AdicionaParametro("p_CARGO", _funcionario.ENT_CARGO.Cargo.ToString)
            .AdicionaParametro("p_CONTRATO_VALOR", _funcionario.ENT_CARGO.Salario.ToString)
    ...
    Public Function Alterar(ByVal _funcionario As entFuncionario, ByVal myConnection As String, ByVal myProcedure As String) As Boolean
        Dim oBanco As New AcessoDados(myConnection)
    ...
    Public Function Excluir(ByVal _funcionario As entFuncionario, ByVal myConnection As String, ByVal myProcedure As String) As Boolean
        Dim oBanco As New AcessoDados(myConnection)
