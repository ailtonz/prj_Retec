...
Public Class F_CAD_OBRA
    ...
    Private Sub SalvarObra()
        ...
        Try
            ...
            With oEtObra
                ...
                ''USUARIO
                With oEtObraUsuario
                    .Nome = F_CAD_CLIENTE.txtUser.Text
                End With
    ...
    Private Sub CARREGAR_GRIDE_OBRAS_CONTATOS(ByVal idObra As String)
        ...
        Dim da As New MySqlDataAdapter(New MySqlCommand("Select * from vw_psq_obras_contatos where ID_OBRA ='" + idObra + "'", myConnection))

        ds.Clear()
        da.Fill(ds, "vw_psq_obras_contatos")

        With dgvOBRAS_CONTATOS
            .DataSource = ds.Tables("vw_psq_obras_contatos")
    ...
    Private Sub LIMPAR_CONTATO_OBRA()
        ...
        With Me
            ...
            .txtCONTATO_OBRA_CAD_USUARIO.Text = F_CAD_CLIENTE.txtUser.Text
            .txtCONTATO_OBRA_CAD_EMISSAO.Text = "00/00/0000"

            .txtCONTATO_OBRA_ALT_USUARIO.Text = F_CAD_CLIENTE.txtUser.Text
