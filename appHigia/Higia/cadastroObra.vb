...
Public Class cadastroObra
    ...
    Private Sub btnSalvarContatoObra_Click(sender As System.Object, e As System.EventArgs) Handles btnSalvarContatoObra.Click
    ...
    Private Sub CARREGAR_GRIDE_OBRAS_CONTATOS(ByVal idObra As String)
        ...
        Dim da As New MySqlDataAdapter(New MySqlCommand("Select * from vw_dgv_obras_contatos where ID_OBRA ='" + idObra + "'", myConnection))

        ds.Clear()
        da.Fill(ds, "vw_dgv_obras_contatos")

        With dgvOBRAS_CONTATOS
            .DataSource = ds.Tables("vw_dgv_obras_contatos")
    ...
    Private Sub getID_Obra(ByVal cepObra As String, ByVal idCliente As String)
        ...
        Dim cmdSQL As New MySqlCommand("SELECT id,cad_usuario,cad_emissao,alt_usuario,alt_emissao FROM vw_cad_clientes_obras WHERE CEP = '" + cepObra + "' AND ID_CLIENTE = '" + idCliente + "'  LIMIT 1", myConnection)
        Dim rdrRegistro As MySqlDataReader
        ...
        With Me
            While rdrRegistro.Read
                ...
                .txtOBRA_CAD_USUARIO.Text = rdrRegistro("CAD_USUARIO").ToString()
                .txtOBRA_CAD_EMISSAO.Text = rdrRegistro("CAD_EMISSAO").ToString()
                .txtOBRA_ALT_USUARIO.Text = rdrRegistro("ALT_USUARIO").ToString()
                .txtOBRA_ALT_EMISSAO.Text = rdrRegistro("ALT_EMISSAO").ToString()
            End While
        End With
    ...
    Private Sub getID_Contato(ByVal idObra As String)
        ...
        Dim cmdSQL As New MySqlCommand("SELECT id,cad_usuario,cad_emissao,alt_usuario,alt_emissao FROM vw_cad_clientes_obras_contatos WHERE id_obra = '" + idObra + "' LIMIT 1", myConnection)
        Dim rdrRegistro As MySqlDataReader
    ...
    Private Sub cmdNovoObraContato_Click(sender As System.Object, e As System.EventArgs) Handles cmdNovoObraContato.Click
        LIMPAR_CONTATO_OBRA()
    End Sub
    ...
    Private Sub CARREGAR_CONTATO_OBRA(ByVal idContatoObra As String)
        ...
        Dim cmdSQL As New MySqlCommand("Select * from vw_cad_clientes_obras_contatos where ID = '" + idContatoObra + "' ", myConnection)
        Dim rdrRegistro As MySqlDataReader
        ...
        With Me
            ...
            While rdrRegistro.Read
                ...
                .txtCONTATO_OBRA_CAD_USUARIO.Text = rdrRegistro("CAD_USUARIO").ToString
                .txtCONTATO_OBRA_CAD_EMISSAO.Text = rdrRegistro("CAD_EMISSAO").ToString

                .txtCONTATO_OBRA_ALT_USUARIO.Text = rdrRegistro("ALT_USUARIO").ToString
                .txtCONTATO_OBRA_ALT_EMISSAO.Text = rdrRegistro("ALT_EMISSAO").ToString
    ...
    Private Sub txtCONTATO_OBRA_EMAIL_Validating(sender As System.Object, e As System.ComponentModel.CancelEventArgs) Handles txtCONTATO_OBRA_EMAIL.Validating
...
"^([a-zA-Z0-9_\-\.]+)@((\[[0-9]{1,3}" + "\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([a-zA-Z0-9\-]+\" + ".)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$"
    ...
    Private Sub txtCONTATO_OBRA_NOME_Validating(sender As System.Object, e As System.ComponentModel.CancelEventArgs) Handles txtCONTATO_OBRA_NOME.Validating
        Me.txtCONTATO_OBRA_NOME.Text = Rotinas.RemoveAcentos(Me.txtCONTATO_OBRA_NOME.Text)
    End Sub

    Private Sub txtCONTATO_OBRA_OBSERVACAO_Validating(sender As System.Object, e As System.ComponentModel.CancelEventArgs) Handles txtCONTATO_OBRA_OBSERVACAO.Validating
        Me.txtCONTATO_OBRA_OBSERVACAO.Text = Rotinas.RemoveAcentos(Me.txtCONTATO_OBRA_OBSERVACAO.Text)
    End Sub

    Private Sub cmdPesquisarContatos_Click(sender As System.Object, e As System.EventArgs) Handles cmdPesquisarContatos.Click
    ...
    Private Sub CARREGAR_GRIDE_CONTATOS(ByVal idObra As String, ByVal strProcurar As String)
        ...
        If strProcurar = "" Then
            strSQL = "Select * from vw_dgv_obras_contatos where ID_OBRA ='" + idObra + "'"
        Else
            strSQL = "Select * from vw_dgv_obras_contatos where ID_OBRA ='" + idObra + "' AND CONTATO LIKE '%" & Trim(strProcurar) & "%'"
        End If
