...
Public Class bcoContatoCliente
    ...
    Public Function Incluir(ByVal _contato As entContato, ByVal myConnection As String) As Boolean
        ...
        With oBanco
            ...
            .ComandoProcedure = "sp_CAD_CLIENTE_CONTATO"
            .CriaProcedure()

            .AdicionaParametro("p_CADASTRO", "CLIENTE")
            .AdicionaParametro("p_ACAO", "INSERT")

            .AdicionaParametro("p_ID_CONTATO", _contato.IdContato.ToString)
            ...
            .AdicionaParametro("p_CONTATO_SOLICITANTE", _contato.Solicitante.ToString)
